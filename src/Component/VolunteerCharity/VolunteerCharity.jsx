  ...
  useEffect(()=>{
    ...
    return <>
        ...
        {seacrchItem && (
                    ...
                    <p className="text-danger">لا توجد نتائج مطابقة</p>
                    )}
                </div>
                )}
              ...
              <tbody>
                {volunteer.length>0 ? 
                  ( volunteer.map((item,index)=>{
                    return (
                      <StyledRow onClick={() => handleRowClick(item.id)} key={item.id}>
                  ...
                  <tr>
                  <td colSpan={6} className="text-center text-danger"> {/* Corrected structure */}
...
export default VolunteerCharity
