...
function AttendanceRecord() {
  ...
  useEffect(()=>{
    ...
    <div className='d-flex flex-column'>
      ...
      <Button variant="primary" onClick={handleShow} className='w-25'  style={{backgroundColor:'rgba(33, 77, 151, 1)', borderRadius:'8px', boxShadow:'0 4px 8px 0 rgb(33, 77, 151)', border:'none'}}>
      QR Code
      </Button>
